...
namespace IvaETicaret.Areas.Customer.Controllers
{
    ...
    public class CityController : Controller
    {
        ...
        // GET: Customer/City/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Customer/City/Create
